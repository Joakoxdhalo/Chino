...
class Pronunciación del Chino mandarín vocales(a, o, e, i, u, ü):
    ...
    def tonos():
        ...
        Tercer tono: En conver normal, se oye como plano y bajo
        Cuarto tono: Como llamando a alguien

    def suenan igual():
        vocales = {a, i, u}
        varias vocales = {ai, ia, iao, ua, ou, ei, ie}

    def Suenan diferente:
        o:
            * Como la 'o' del español
            * Como /uo/
            * Como /uoa/
        e:
            * Persona moribunda pronunciando la 'e'
            * Como /ea/
        ü:
            * Como la 'ü' de alemania ó como la 'u' de francia

    def cambio natural(ui, iu):
        * ui --> /uei/
        Ejm:
        shǔi --> /shuei/  agua
...
class pronunciación del chino mandarín consonantes():
    def Iguales al español():
    f - l - m - n
    ...
    def Diferentes():
        ...
        *k --> 'k' inglesa, (Ej: kind, no noto la diff)
        ...
        De oreja a oreja y la lengua abajo:
        ...
        Las siguientes  son con la lengua en el paladar y la boca abierta, con los dientes juntos:

        zh --> /j/
        ch --> /ch/
        sh --> /sh/
        r --> /ll/ (Ej: llamar), pero también tiende a ser una 'r'

        y --> 'i' (Ej: yǒu /iou/ (amigo))
        w --> 'u' (Ej: wà zi /uà dz/ (calcetines))
...
Yo soy colombiano
wǒ shì gē lún bǐ yǎ rén
我是哥伦比亚人

Ella también es colombiana
tā yě shì gē lún bǐ yǎ rén
他也是哥伦比亚人

mi mamá también es colombiana
wǒ de māmā yě shì gē lún bǐ yǎ rén
我的妈妈也是哥伦比亚人
...
\yo estudio en brasil portugués\
wǒ zai ba xi xuexi puta oya
...
En china la ropa es muy cara, en Colombia la ropa es muy barata.
/la ropa muy cara en china, la ropa muy barata en Colombia/


/la ropa muy barata en China, la ropa muy cara en Colombia./
yī fú hěn lián jià zhōng guó, yī fú hěn áng guì gēlúnbǐyǎ.
衣服很廉价中国， 衣服很昂贵哥伦比亚
...
Partícula de pregunta cerrada: ma
吗
...
/Tu perro llama qué/
ni de gou jiao shen me?
你打狗叫什么

Su perro se llama Boris
ta de gou jiao Boris
他的狗叫Boris
...
class temporalidades_3():
    ...
    Ante ayer va primero que hoy, por eso se escribe así en chino
...
Yo quiero ir a San Andrés (B)
Wo xiang qù San Andrés

Escibir
xie

Hoy en la noche quiero comer comida china
jīn tiān wǎn shang wǒ xiǎng chī zhōng guo cài
今天晚上我想吃中国菜
...
Yo puedo escribir los símbolos chinos
...
A los colombianos les gusta jugar futbol
(ti) para "patear"
...
El ejercicio es hacer oraciones largas con esos 5 verbos:

1. Mi papá puede viajar en avión


wǒ ta bàba néng qù lǔxing fei ji
我的爸爸能去撸型飞机
sinónimos de viajar:
游
...
2. A mi mamá le gustan las manzanas
wǒ de màma xǐ huān Píngguǒ
我的妈妈喜欢苹果

3. Ellos también tienen frutas
ta men yě yǒu shuǐguǒ
他们也有水果

4. El profesor está ocupado escribiendo
lǎoshī máng xiě
老师忙写
...
Tú comes comida china
nǐ chī zhōng guó cài ma?
你吃中国菜吗?

Yo como comida francesa
wǒ chī fà guó cài
我吃法国菜
...
Dónde está el banco de Bogotá?
/Bogotá banco está dónde?/
Bogotá yín háng zài nǎ?

Dónde está el banco de Colombia?
...
Yo me levanto cada día a las 5
/yo cada día por la mañana a las 5 me levanto/
wǒ měi tiān zǎo shang 5 diǎn qǐ chuáng
我每天早上 5 点起床
...
wǒ měi tiān wǎn shang bā(8) shaì jiào
我每天晚上八睡觉
...
**** Me genera la duda el xià
Quiero jugar al fútbol hoy
Jīntiān xià wǒ xiǎng tī zúqiú
今天     下  我  想   踢  足球

Yo estoy aprendiendo chino en china.
...
Yo hablo español inglés y chino?
wǒ shuō xī bān yán yǔ, yīng yǔ hé hàn yǔ
我说西班牙语，英语 和 汉语

A los colombianos les gusta tomar café
gē lún bǐ yǎ rén ài hē kāfē
哥伦比亚人爱喝咖啡

A los colombianos les gusta la comida china
gē lún bǐ yǎ rén ài chī zhōng guó cài
哥伦比亚人爱吃中国菜
...
China y Colombia son amigos
zhōng guó hé gēlúnbǐyǎ shi péng you
中国和哥伦比亚是朋友
...
1) Yo debería visitar la mamá de mi amigo
